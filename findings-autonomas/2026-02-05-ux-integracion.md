...
Reglas: sin cambios de arquitectura/negocio/DB/Redis; solo auditoría + tracking en `docs/errors/`.
...
- Tracking: `docs/errors/20260205_employees_stats_public_missing.md` (ERR-20260205-STATS-PUBLIC)
...
- Tracking: `docs/errors/20260205_employees_order_actions_missing.md` (ERR-20260205-EMP-ORDER-ACTIONS)
...
- Tracking: `docs/errors/20260205_employees_sessions_payments_missing.md` (ERR-20260205-EMP-SESSIONS-PAYMENTS)
- Relacionado: `docs/errors/20260204_employees_sessions_all_missing.md` (ERR-20260204-SESSIONS-ALL)
...
- Tracking: `docs/errors/20260205_client_tables_areas_endpoints_missing.md` (ERR-20260205-CLIENT-TABLES-AREAS)
...
- Tracking existente: `docs/errors/20260203_static_paths_pronto_static.md` (ERR-20260203-STATIC-PATHS)
...
- Tracking: `docs/errors/20260205_client_ticket_pdf_missing.md` (ERR-20260205-CLIENT-TICKET-PDF)
...
- Tracking: `docs/errors/20260205_client_promotions_endpoint_mismatch.md` (ERR-20260205-CLIENT-PROMOTIONS-MISMATCH)
...
- Tracking: `docs/errors/20260205_client_static_host_hardcode.md` (ERR-20260205-CLIENT-STATIC-HARDCODE)
...
- Tracking: `docs/errors/20260205_employees_logo_extension_mismatch.md` (ERR-20260205-EMP-LOGO-EXT)
...
- Tracking: `docs/errors/20260205_a11y_system_order_status_labels_inputs_unlabeled.md` (ERR-20260205-A11Y-SYS-STATUS-LABELS)
