...
ESTADO: RESUELTO
SOLUCION: Se ejecutó `./pronto-scripts/bin/pronto-no-runtime-ddl` y el resultado fue `OK: no runtime DDL hits`; no hay violaciones activas del gate de DDL runtime.
