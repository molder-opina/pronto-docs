...
- Resuelto ahora: pronto-tests alineó defaults legacy de credenciales Playwright/E2E employees con las cuentas QA vigentes.
- ACTUALIZACION_2026-03-18 (TICKET-D2): Se verificó drift=0 en migraciones e init. Se confirmó eliminación de monolitos TS y reducción del 50% en order_service_impl.py. El monorepo está sincronizado.
ESTADO: RESUELTO
